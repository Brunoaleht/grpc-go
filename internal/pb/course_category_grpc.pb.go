...
const (
	...
	CategoryService_GetListCategories_FullMethodName                 = "/pb.CategoryService/GetListCategories"
...
type CategoryServiceClient interface {
	...
	GetListCategories(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*CategoryList, error)
...
func (c *categoryServiceClient) GetListCategories(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*CategoryList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CategoryList)
	err := c.cc.Invoke(ctx, CategoryService_GetListCategories_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CategoryServiceServer interface {
	...
	GetListCategories(context.Context, *Blank) (*CategoryList, error)
...
func (UnimplementedCategoryServiceServer) GetListCategories(context.Context, *Blank) (*CategoryList, error) {
...
func _CategoryService_GetListCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CategoryService_GetListCategories_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).GetListCategories(ctx, req.(*Blank))
	}
	return interceptor(ctx, in, info, handler)
}
